...
/**
 * Clase que representa el grafo de la clínica veterinaria. Usa matriz de
 * adyacencia para modelar las conexiones entre salas, aplicando el algoritmo de
 * Dijkstra para calcular rutas mínimas.
 */
public class GrafoClinica {
	...
	/**
	 * Calcula las rutas mínimas desde una sala origen usando el algoritmo de
	 * Dijkstra.
	 * 
	 * @param inicio Índice de la sala desde la cual se calcularán las rutas.
	 * @return Un arreglo de Strings indicando la distancia mínima desde la sala
	 *         origen a cada sala.
	 */
