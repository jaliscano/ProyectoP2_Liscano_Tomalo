...
/**
 * Clase ControladorClinica que gestiona la lógica principal del sistema
 * veterinario. Controla el registro de mascotas y la gestión de las salas
 * internas de la clínica. Actúa como intermediario entre la vista y el modelo.
 */
public class ControladorClinica {
	...
	/**
	 * Constructor que inicializa el árbol de mascotas y el grafo de la clínica. Se
	 * definen las salas principales y sus conexiones internas.
	 */
	...
	/**
	 * Calcula las rutas mínimas desde una sala específica a las demás usando el
	 * grafo.
	 * 
